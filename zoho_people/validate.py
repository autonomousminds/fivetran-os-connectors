"""
Local validation runner for the Zoho People connector.
...
print(f'  duckdb {db_path} -c "SELECT COUNT(*) FROM form_p_employee;"')
print(f'  duckdb {db_path} -c "SELECT COUNT(*) FROM attendance_daily;"')
print(f'  duckdb {db_path} -c "SELECT COUNT(*) FROM leave_records;"')
print(f'  duckdb {db_path} -c "SELECT COUNT(*) FROM timelogs;"')
con.close()
